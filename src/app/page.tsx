...
/**
 * Login page with role selection and glassmorphic design
 * Supports student, teacher, and admin role selection
 */
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="p-3 rounded-full glassmorphic glow-cyan">
        ...
        {/* Login Form */}
        <Card className="glassmorphic glow-purple">
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button 
                      variant="outline" 
                      className="w-full justify-between glassmorphic hover:glow-cyan"
                    >
                  ...
                  <DropdownMenuContent className="w-full glassmorphic">
                    {roles.map((role) => (
                      <DropdownMenuItem
                        key={role.value}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="glassmorphic border-white/20 focus:border-cyan-500/50"
                  required
                />
              </div>
            ...
            {/* Demo Credentials */}
            <div className="mt-6 p-4 glassmorphic rounded-lg border border-white/10">
